...
总之，以上定位热图和P-R曲线说明了本文提出的方法相比于CAM和Grad-CAM能够更好地处理多类疾病标记物定位问题。
%\begin{table}[!htbp]
%	\centering
