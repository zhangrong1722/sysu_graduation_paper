...
\section{不同超参数下的实验结果分析}\label{sec:multi_classes_dis_score_hist}
在本小节中，本文将探究。
\begin{table}[h]
	\centering
	...
	\resizebox{1.0\textwidth}{!}{
		\begin{tabular}{c|c|c|c|c|c|c|c}
			...
			\midrule[2pt]
			第一类异常	& $\textbf{0.481}$ &	$0.421 $ & $0.433$ & $0.056$ & $0.085$& $0.012$ &	 \\\hline
			
			第二类异常	& $\textbf{0.481}$ &	$0.421 $ & $0.433$ & $0.056$ & $0.085$& $0.012$ &	 \\\hline
